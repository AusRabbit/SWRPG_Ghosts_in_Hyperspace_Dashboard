# Ghosts in Hyperspace — Live Dashboard

The player- and GM-facing dashboard for *Ghosts in Hyperspace*, a Star
...
Current party: **Sabrina**, **Kett**, **Talli**.
...
- **`data/live.json`** — the small set of values that change *during*
  ...
  ```json
  {
    ...
    "wounds": { "sabrina": 0, "kett": 0, "talli": 0 },
    "strain": { "sabrina": 0, "kett": 0, "talli": 0 },
    "criticalInjuries": { "sabrina": [], "kett": [], "talli": [] },
